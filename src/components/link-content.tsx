...
import type { CategoryWithLinks } from '@/actions'

interface LinkContentProps {
  source: CategoryWithLinks
}

export function LinkContent({ source }: LinkContentProps) {
  return (
...
function LinkItem({ link }: { link: SiteLink }) {
  return (
